...
/**
 * Plugin entrypoint that wires all abilities, including the rewritten Bankai system.
 */
public class ZangetsuPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        registerCommands();
        getLogger().info("Abilities loaded with Tensa Zangetsu Bankai system.");
    }
    ...
    public void onDisable() {
        ...
        getLogger().info("Abilities disabled.");
    }
